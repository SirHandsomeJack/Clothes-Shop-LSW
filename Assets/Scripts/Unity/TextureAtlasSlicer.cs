...
namespace SirHandsomeJack.Unity
{
    public class TextureAtlasSlicer : EditorWindow
    {
        ...
        [MenuItem("CONTEXT/TextureImporter/Import XML")]
        ...
        [MenuItem("CONTEXT/TextureImporter/Import XML", true)]
        ...
        private void PerformSlice()
        {
            ...
            if (root.Name.Equals("TextureAtlas"))
            {
                ...
                {
                    if (childNode.Name.Equals("SubTexture"))
                    {
                        try
                        {
                ...
                else Debug.LogWarning("Failed to import XML. Reason: SubTextures could not be located.");
            }
            else Debug.LogWarning("Failed to import XML. Reason: Could not find <i>TextureAtlas</i> root node.");
        }
